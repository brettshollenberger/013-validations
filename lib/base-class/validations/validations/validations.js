angular
  .module('BaseClass')
  .factory('BCValidations.Validations', ['BCValidations.Validation', 
      'BCValidations.builtInValidators', 'BCValidations.ValidationNotFoundError',
      'BCValidations.ValidationMessageNotFoundError', 'BCErrors',
      function(Validation, builtInValidators, ValidationNotFoundError,
               ValidationMessageNotFoundError, Errors) { 

    return function Validations(validationsDescription) {
